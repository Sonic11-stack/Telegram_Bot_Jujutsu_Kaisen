...
def response(function_call):
  ...
  elif function_call.data == "saving":
        botJujutsuKaisen.send_message(function_call.message.chat.id, "Хорошо, теперь запишите номер тома и главы, а также страницу")
        
  elif function_call.data == "reading":
        botJujutsuKaisen.send_message(function_call.message.chat.id, "Давайте я напомню вам сохранённый момент: " + "\n" + "Том: {}" + "\n" + "Глава: {}" + "\n" + "Страница: {}")
